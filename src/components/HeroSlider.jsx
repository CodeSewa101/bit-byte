...
const HeroSlider = () => {
  ...
  return (
    <div className="relative h-screen w-full overflow-hidden">
      ...
      <div className="absolute top-4 max-[640px]:top-12 left-0 right-0 z-30 pt-4 sm:pt-4  lg:pt-8">
        <div className="text-center">
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-white drop-shadow-2xl">
            ...
            <span className="sm:ml-4 text-white/90 font-semibold">
              Computer Institute
            </span>
          </h1>
          <div className="mt-2 sm:mt-3">
            <div className="inline-block h-1 w-16 sm:w-20 lg:w-24 bg-gradient-to-r from-orange-400 to-amber-400 rounded-full"></div>
          </div>
        </div>
      </div>

      {/* Main Content */}
      <div className="relative z-10 h-full flex items-center pt-24 sm:pt-32 lg:pt-40">
        <div className="container mx-auto px-4 sm:px-6 lg:px-12">
          <div className="flex flex-col lg:flex-row gap-6 sm:gap-8 lg:gap-12 items-center">
            {/* Text Content */}
            <div className="text-center lg:text-left flex-1 order-2 lg:order-1">
              ...
              {/* Heading with typewriter */}
              <h2
                className={`text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4 sm:mb-6 leading-tight transition-opacity duration-300`}
                style={{
                  opacity: isTransitioning ? 0.3 : 1,
                  filter: isTransitioning ? "blur(2px)" : "blur(0px)",
                  minHeight: isMobile ? "80px" : "120px",
